...
<head>
	<meta charset="UTF-8">
	<title>Klantenoverzicht - Camping Le Passage</title>
				...
				<div>
					<div class="klanten">
						<h2>Klantenoverzicht</h2>
							<div>
                            <a href="klantzoeken.php"><button type="button">Klant zoeken</button></a>
                        <table width="780px">
                        <tr>
							...
							if(mysqli_connect_errno()){
								...
								$sql="select klantid, voornaam, naam, email, actief from tblklanten";
								if($stmt = $mysqli->prepare($sql))
								{
								if(!$stmt->execute())
								{
